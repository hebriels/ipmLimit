$("#imgInvoice").fileinput({
    ...
    required: true,
    allowedFileExtensions: ['jpeg','jpg','JPEG','JPG','png','PNG'],
    language: 'ru',
    //showBrowse: false,
    browseOnZoneClick: true,
    defaultPreviewContent: '<h4 class="text-muted">Перетащите изображение или кликните для выбора прямо здесь.</h4>',
